...
def add_user_in_project(project_id, invited_user_email, owner_id):
    """
    ...
    if project and project.owner_id == owner_id:
        ...
        if added_user and user_repo.user_exists(owner_id):
            ...
            return added_user, ResultsCodes.OK
        else:
            return None, ResultsCodes.USER_NOT_FOUND
    else:
